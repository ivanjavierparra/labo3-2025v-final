...
def optimizar_con_optuna_sin5FCV_con_semillerio_db(df_train, df_val, semillas=[42, 101, 202, 303, 404], version="v1", n_trials=500, pesos="log"):
    """
    ...
    def objective(trial):
        ...
        for seed in semillas:
            ...
            trial.set_user_attr("mae", mean_squared_error(y_val, y_pred))  # por si querés ver MAE también
            rmse_seeds.append(tfe)
...
def semillerio_en_prediccion_con_pesos(df_train, df_val, df_test, version="v1", pesos="log"):
    """
    ...
    X_test = df_test[feature_cols]  # Si podés, asegurate que están en el mismo orden y tipo que en train
    ...
    result_df = df_test[['periodo', 'product_id', 'target']].copy()
